...
public class Main {
    ...
    public static void showDayStatus(int year, int month, int day) {
        boolean dayWeekend;
        boolean dayHoliday;
        ...
        dayHoliday = isDayHoliday(month, day);
        if (dayWeekend == true) {
    ...
    public static boolean isDayHoliday(int month, int day) {
